...
public class ObjectPoolH : MonoBehaviour
{
    public static ObjectPoolH instance;
    ...
    {
        GameObject originalPrefab = objectToReturn.GetComponent<PooledObjectH>().originalPrefab;
    ...
    private void CreateNewObject(GameObject prefab)
    {
        ...
        newObject.AddComponent<PooledObjectH>().originalPrefab = prefab;

...
public class JumpAttackState_Phat : EnemyState_Phat
{
    ...
    public JumpAttackState_Phat(Enemy_Phat enemyBase, EnemyStateMachine_Phat stateMachine_Phat, string animBoolName) : base(enemyBase, stateMachine_Phat, animBoolName)
    {

...
public enum BossWeaponType {Flamethrower}

public class Enemy_BossP : Enemy_Phat
{
    [Header("Boss details")]
    ...
    public IdleState_Phat idleState { get; private set; }
    public MoveState_Phat moveState { get; private set; }
    public AttackState_Phat attackState { get; private set; }
    public JumpAttackState_Phat jumpAttackState { get; private set; }
    public AbilityState_Phat abilityState { get; private set; }
    public DeadState_Phat deadState { get; private set; }

    public Enemy_BossVisualsP bossVisuals { get; private set; }
    protected override void Awake()
    {
        base.Awake();

        bossVisuals = GetComponent<Enemy_BossVisualsP>();

        idleState = new IdleState_Phat(this, stateMachine_Phat, "Idle");
        moveState = new MoveState_Phat(this, stateMachine_Phat, "Move");
        attackState = new AttackState_Phat(this, stateMachine_Phat, "Attack");
        jumpAttackState = new JumpAttackState_Phat(this, stateMachine_Phat, "JumpAttack");
        abilityState = new AbilityState_Phat(this, stateMachine_Phat, "Ability");
        //deadState = new DeadState_Phat(this, stateMachine_Phat, "Idle"); // Idle is just a placeholder we use ragdoll
    }
    ...
    protected override void Start()
    {
        ...
        stateMachine_Phat.Initialize(idleState);
    }
    ...
    protected override void Update()
    {
        ...
        stateMachine_Phat.currentState.Update();
    ...
    public override void GetHit()
    {
        ...
        if (healthPoints <= 0 && stateMachine_Phat.currentState != deadState)
            stateMachine_Phat.ChangeState(deadState);
    }
    ...
    public override void EnterBattleMode()
    {
        ...
        stateMachine_Phat.ChangeState(moveState);
    }

...
public class Enemy_Phat : MonoBehaviour
{
    ...
    public EnemyStateMachine_Phat stateMachine_Phat { get; private set; }


    protected virtual void Awake()
    {
        stateMachine_Phat = new EnemyStateMachine_Phat();
    ...
    public void AnimationTrigger() => stateMachine_Phat.currentState.AnimationTrigger();



    public virtual void AbilityTrigger()
    {
        stateMachine_Phat.currentState.AbilityTrigger();
    }
